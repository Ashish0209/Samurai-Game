'use server';
// to make a rooms for us same as new document
...
CreateDocumentParams) =>{
    ...
    try{
        ...
        const room = await liveblocks.createRoom(roomId, {
          ...
          return parseStringify(room);  // it makes a deep copy of the previous room.
...
export const getDocument = async ({ roomId, userId }: { roomId: string; userId: string }) => {
    try {
        ...
        // its an array of room of different objects
